...
export default async function Footer() {
  ...
  return (
    <footer className="bg-[var(--color-surface-alt)] border-t border-[var(--color-border)] mt-auto">
      <div className="container-page py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Links */}
          <div>
            <p className="font-semibold text-[var(--color-text)] mb-3 text-sm uppercase tracking-wide">
          ...
          <div>
            ...
            {siteConfig.social.instagram && (
              <a
                ...
                className="inline-flex items-center gap-1.5 mt-3 text-sm text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors duration-200"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
        ...
        <div className="border-t border-[var(--color-border)] mt-8 pt-6 text-center text-xs text-[var(--color-text-subtle)]">
